import {
  Title
} from "./chunk-Q23IVZBI.js";
import "./chunk-QERGW76I.js";
import "./chunk-V2UTUIKY.js";
import {
  ...
  getChildConfig(injector, route, segments) {
    return __async(this, null, function* () {
      ...
      if (route.loadChildren) {
        ...
        if (shouldLoadResult) {
          const cfg = yield firstValueFrom(this.configLoader.loadChildren(injector, route));
          if (!cfg) {
...
var RECOGNIZE_IMPL = new InjectionToken("RECOGNIZE_IMPL", {
  providedIn: "root",
  factory: () => {
    return recognize$2;
  }
    ...
    return this.transitions.pipe(
      ...
      switchMap((overallTransitionState) => {
        ...
        return of(overallTransitionState).pipe(
          ...
          take(1),
          takeUntil(abortSignalToObservable(abortController.signal).pipe(
